...
Мкеханизм доверенных сертификатов позволяет загрузить в DDP корневые и промежуточные сертификаты (CA) или сертификаты серверов. Платформа использует их при проверке TLS/SSL при подключении к внешним сервисам по HTTPS — например, при обращении к API внешних сервисов, источников данных, виджетов и действий.

Это даёт возможность безопасно работать с сервисами, использующими самоподписные или корпоративные сертификаты, без отключения проверки SSL.
