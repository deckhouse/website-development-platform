...
description: График временных рядов на основе диапазонного PromQL-запроса к Prometheus.
weight: 10
---
...
| Лейбл                 | Да             | Имя лейбла Prometheus, используемое как название серии в легенде графика                                      | —                     |
