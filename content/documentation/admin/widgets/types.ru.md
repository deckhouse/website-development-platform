...
Виджет выводит одно число по instant-запросу к Prometheus на **конце** выбранного интервала. Запрос в формате PromQL должен возвращать тип **Scalar** или тип **Vector** с одним значением.
...
|----------------------------------|----------------|-------------------------------------------------------------------------------------------------------------------------------|-----------------------|
| URL                              | Да         | URL Prometheus                                                                                                                | -                     |
| Запрос                           | Да         | PromQL instant-запрос на конце выбранного интервала                                                                           | -                     |
| Интервал по умолчанию            | Нет            | Интервал при загрузке виджета и при обновлении, если пользователь не выбрал другой диапазон в панели виджета                  | Последний час         |
