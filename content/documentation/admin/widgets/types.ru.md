...
| Название     | Обязательность  | Описание                                         | Значение по умолчанию |
|--------------|-----------------|--------------------------------------------------|-----------------------|
| ID проекта   | **да**          | Идентификатор проекта в GitLab. Пример: `12345`  | -                     |

### Конфигурация для Bitbucket

| Название                  | Обязательность  | Описание                              | Пример   | Значение по умолчанию |
|---------------------------|-----------------|---------------------------------------|----------|-----------------------|
| Ключ проекта              | **да**          | Ключ проекта в Bitbucket              | MYPROJ   | -                     |
| Идентификатор репозитория | **да**          | Идентификатор репозитория в Bitbucket | my-repo  | -                     |
