...
Виджет позволяет просматривать структуру и содержимое файлов в репозиториях. Виджет отображает файлы в виде дерева, позволяет просматривать содержимое файлов с подсветкой синтаксиса для различных языков программирования, отображать изображения и Markdown файлы.
...
| ID проекта   | **обязательно** | ID проекта в GitLab (например, "123" или "group/project")        | -                     |
