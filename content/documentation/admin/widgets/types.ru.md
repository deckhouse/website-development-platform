...
Виджет отображает теги репозитория GitHub с информацией о коммите (автор, дата, описание) и позволяет создавать теги.
...
Виджет позволяет создать теги в GitHub. В диалоге «Создать тег» указываются:

| Название      | Обязательность  | Описание                                                                            | Значение по умолчанию |
|---------------|-----------------|-------------------------------------------------------------------------------------|-----------------------|
| Название тега | **да**          | Название создаваемого тега.                                                         | -                     |
| Создать из    | **да**          | Ветка или существующий тег, от которого создаётся новый тег (выбор из списка).      | -                     |
| Описание      | нет             | Описание тега. Если указано, создаётся аннотированный тег; иначе — lightweight-тег. | -                     |
