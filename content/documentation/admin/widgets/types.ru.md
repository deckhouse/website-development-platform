...
| Название                  | Опциональность  | Описание                              | Пример   | Значение по умолчанию |
|---------------------------|-----------------|---------------------------------------|----------|-----------------------|
| Ключ проекта              | **обязательно** | Ключ проекта в Bitbucket              | MYPROJ   | -                     |
| Идентификатор репозитория | **обязательно** | Идентификатор репозитория в Bitbucket | my-repo  | -                     |
