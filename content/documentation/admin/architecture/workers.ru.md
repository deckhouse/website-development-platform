...
Параметры этих операций задаются в секции `clickhouse.replication` настроек модуля: размер и периодичность переноса, перестроение индексов и интервал удаления истории несуществующих объектов.
