...
- **Frontend**: Заголовки добавляются на уровне Nginx веб-сервера, который используется в компоненте DDP Frontend для раздачи статических файлов и HTML страниц
