...
* Вебхуки (Webhooks) — механизм приёма данных во входящих POST-запросах от внешних систем, подробнее в разделе [«Вебхуки»](https://deckhouse.ru/products/development-platform/documentation/admin/webhooks/).
...
Параметр `datasources.logging.enabled` в конфигурационном файле DDP backend управляет выводом логов запуска источника данных в stdout.
При значении `true` логи выводятся в stdout, при значении `false` — нет.
