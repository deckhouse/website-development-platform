...
Каждый webhook обладает собственным URL, который формируется следующим образом `<url backend>/webhooks/<UUID вебхука>`. На данном URL вебхук принимает POST запросы с массивом данных любого формата, который обрабатывается на основе правил вебхука.
