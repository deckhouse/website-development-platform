...
title: Обзор
weight: 10
description: Создание и запуск процессов — элементы схемы, параметры, хранилище и управление выполнением. Автоматизация бизнес-сценариев.
---
...
- Выполнения всех входящих элементов для продолжения выполнения.
- Выполнения как минимум одного входящего элемента для продолжения выполнения.
