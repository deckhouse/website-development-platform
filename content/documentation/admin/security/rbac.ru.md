...
Реестр шаблонов:
- `read:template-registry` — просмотр настроек реестра шаблонов и каталога версий. Подробнее — в разделе [«Реестр шаблонов»](../template-registry/).
- `update:template-registry` — изменение источников и настроек, отзыв и удаление версий шаблонов.
- `sync:template-registry` — запуск синхронизации реестра шаблонов.
