...
DDP позволяет добавлять в хранилище корневые и промежуточные сертификаты (CA) или сертификаты серверов. Они используются при проверке TLS в исходящих HTTPS-запросах к внешним сервисам (в действиях, виджетах, источниках данных и др.). Управление доверенными сертификатами выполняется через веб-интерфейс в разделе «Администрирование» → «Доверенные сертификаты».
