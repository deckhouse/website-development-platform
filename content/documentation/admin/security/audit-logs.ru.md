...
Аудит-логи — это механизм записи всех операций, выполняемых пользователями через API Deckhouse Development Portal (DDP). Логи сохраняются в базе данных PostgreSQL и используются для аудита действий пользователей.
