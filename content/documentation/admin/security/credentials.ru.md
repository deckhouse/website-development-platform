...
В разработке находится механизм для хранения учетных данные во внешнем хранилище, совместимом с HashiCorp Vault, вместо базы данных PostgreSQL.
...
1. Извлекаются и расшифровываются учетные данные
