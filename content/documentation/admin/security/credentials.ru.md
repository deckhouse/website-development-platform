...
Виджеты действий (widget actions) используют учетные данные аналогично обычным действиям. При выполнении действия из виджета система определяет пользователя и использует его учетные данные.
