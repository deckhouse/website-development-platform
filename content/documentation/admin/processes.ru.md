...
Эксклюзивный шлюз позволяет настраивать ветвление процесса по условиям. По умолчанию проверяется статус предыдущей задачи и в зависимости от него выполнение идет по «успешной» или «неуспешной» ветке.
...
Если проверка условий выполняется, то процесс идет по «успешной» (зеленой) ветке, если нет — по «неуспешной» (красной) ветке.
...
Элемент «Цикл» можно ставить после «Эксклюзивного шлюза» или «Параллельного шлюза», если нужно повторять ветку, которая были выбрана, либо использовать для упрощения схемы, когда один и тот же блок шагов нужно пройти фиксированное число раз.
