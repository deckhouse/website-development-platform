...
2. У действия задан **непустой** список правил «Запись в хранилище процесса».
3. Для каждого правила выполняется Go-шаблон (Источник) с данными response; полученная строка записывается в хранилище под ключом (Ключ в хранилище).
