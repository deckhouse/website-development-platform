...
От элемента «Цикл» должны выходить **ровно две связи** к **разным** элементам:
...
Примечание всегда позиционируется за остальными элементами и может использоваться для визуального выделения блоков процесса. Также это единственный элемент, размер которого можно изменить.
