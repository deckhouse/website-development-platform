...
* **Ошибка** — остановка запуска процесса со статусом «Неудачно»; дальнейшее выполнение не продолжается.
...
Элемент **Ошибка** принудительно переводит **запуск** процесса в статус **Неудачно**: при достижении этого узла выполнение останавливается, в том числе на параллельных ветках. От элемента не должно исходить связей к следующим элементам.
