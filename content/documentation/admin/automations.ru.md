...
* **Условие** — условие в формате [Go template](https://developer.hashicorp.com/nomad/tutorials/templates/go-template-syntax), описывающее, изменения какого параметра будет считаться триггером для запуска автоматизации и какое именно значение должен принять измененный параметр
