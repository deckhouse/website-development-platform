...
При настройке внешних сервисов необходимо указать соответствующие HTTP-заголовки для авторизации. Ниже приведён список внешних сервисов, поддерживаемых порталом, с указанием типа авторизации и необходимых заголовков.

{{< alert level="info" >}}
Приведённые ниже примеры демонстрируют возможные способы авторизации для каждого сервиса. В некоторых сервисах могут использоваться другие механизмы. Портал поддерживает все варианты, которые можно передать через HTTP-заголовки.
{{< /alert >}}
