...
| **Идентификатор**            | Уникальный человекочитаемый идентификатор                                                                                                                                                                      |
...
| **Отключить проверку SSL**   | Отключение проверки SSL-сертификата внешнего сервиса (например, при использовании самоподписных сертификатов). Рекомендуется вместо этого добавить нужные сертификаты в [доверенные](../trusted-certificates/) |
