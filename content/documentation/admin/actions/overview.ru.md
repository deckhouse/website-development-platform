...
Можно автоматически обновить учётные данные пользователя, указав в правилах обновления:
...
По умолчанию учётные данные обновляются для пользователя, который запустил действие (инициатора). Если необходимо обновить учётные данные другого пользователя, можно включить опцию **обновлять учётные данные конкретного пользователя** и выбрать нужного пользователя.
