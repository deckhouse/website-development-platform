...
Каждое действие отправляет HTTP запрос на встроенный backend, либо на URL webhook backend. В подавляющем большинстве случаев запрос должен содержать тело, в котором описывается спецификация данного запроса.
