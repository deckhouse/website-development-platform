...
В разделе «Пользовательская форма» указываются параметры, доступные при запуске действия. Типы параметров описаны в документации в разделе [«Параметры»](../../user/properties/).
