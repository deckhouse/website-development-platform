...
При выполнении действия платформа формирует HTTP-запрос к бэкенду.
...
Для любого вебхук-действия в поле **URL** указывается URL внешнего бэкенда, на который будет отправлен запрос.
...
Для вебхук-действий проверяется сертификат внешнего бэкенд-сервиса, для встроенных действий — сертификат инфраструктурного сервиса, с которым выполняется взаимодействие.
...
Headers – HTTP-хедеры в формате ключ-значение, которые будут добавлены в запрос к вебхуку бэкенда. Для встроенных действий хедеры добавляются автоматически в зависимости от типа действия.
