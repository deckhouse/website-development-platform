...
Действия — это механизм платформы Deckhouse Development Platform (DDP) для запуска операций во внешних инфраструктурных системах и сервисах. С их помощью можно, например:
...
- создавать топики и access control list (ACL) в Kafka.
