...
| Название            | Обязательность  | Описание                                                                         | Значение по умолчанию |
|---------------------|-----------------|----------------------------------------------------------------------------------|-----------------------|
| duration_seconds    | **обязательно** | Базовая длительность ожидания в секундах (0–86400, т. е. до 24 часов)            | -                     |
| max_jitter_seconds  | опционально     | Максимальная случайная добавка к ожиданию в секундах (0–N). 0 — джиттер отключён | 0                     |
| description         | опционально     | Описание для отображения в логах и ответе действия                               | -                     |
