...
{{< alert level="info" >}}
Для выполнения действий необходимо наличие токена Sonarqube с типом User Token, сгенерированный пользователем, от имени которого будет запускаться выполнение действия.
{{< /alert >}}
