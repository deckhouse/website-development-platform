...
Платформа требует расширение PostgreSQL `pg_trgm`. При использовании внешнего PostgreSQL включите его до запуска DDP: подключитесь к базе данных от имени пользователя с правами на создание расширений и выполните:
