...
| InsecureSkipVerify  | Отключить проверку TLS/SSL-сертификата                             | true, false                            |
| Заголовки           | Заголовки запроса к Prometheus                                     |                                        |
...
Дополнительно поддерживается шаблонизация учетных данных. Можно обращаться к данным конкретной сервисной учетной записи через синтаксис {{ .credentials.<название_реквизита> }}.
...
| URL                 | Адрес Gitlab                                                |                                                                                                                   |
| InsecureSkipVerify  | Отключить проверку TLS/SSL-сертификата                      | true, false                                                                                                       |
| Заголовки           | Заголовки запроса к Gitlab                                  |                                                                                                                   |
...
Для указания токена авторизации (или других заголовков) также допускается использовать шаблонизацию, например:

```go
{{ .credentials.defectdojo_token }}
```
...
| URL                 | Адрес DefectDojo, например, `https://dd.example.com`     |                     |
| InsecureSkipVerify  | Отключить проверку TLS/SSL-сертификата                   | true, false         |
| Заголовки           | Заголовки HTTP-запроса, например, токен для авторизации  |                     |
...
| Условия             | Условия для сравнения количества уязвимостей по severity       |                    |
| URL                 | Адрес CodeScoring, например, `https://codescoring.example.com` |                    |
| InsecureSkipVerify  | Отключить проверку TLS/SSL-сертификата                         | true, false        |
| Заголовки           | Заголовки HTTP-запроса, например, токен для авторизации        |                    |
...
| InsecureSkipVerify  | Опционально     | Отключить проверку TLS/SSL-сертификата                     | true, false         |
| Заголовки           | Опционально     | Заголовки HTTP-запроса, например, токен для авторизации    |                     |
...
| InsecureSkipVerify | Опционально     | Отключить проверку TLS/SSL-сертификата                    | true, false           |
| Заголовки          | Опционально     | Заголовки HTTP-запроса                                    |                       |
