...
Это тело запроса передаёт в GitLab API название проекта, ID группы и путь репозитория. Подробнее о настройках в [документации](../actions/types/#creategitlabproject).
