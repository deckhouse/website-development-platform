...
Добавлен виджет **Task Queue** для мониторинга очереди задач и работы воркеров ([подробнее](../admin/widgets/types/#task-queue)):
...
Добавлен набор данных **GitLab** для быстрого подключения к GitLab и начала сбора и анализа репозиториев ([подробнее](../admin/seeds/#gitlab)):
...
Добавлен механизм внешними сервисами ([подробнее](../admin/external_services/)):
