---
title: Overview
description: Documentation for the Deckhouse Development Portal product
weight: 10
params:
  no_list: true
outputs:
...
Deckhouse Development Portal (DDP, portal) is a comprehensive solution for managing all stages of development through a single interface.

The portal helps IT professionals work more efficiently — it automates operations related to the service lifecycle and provides tools to assess the overall system performance.
