...
### Автоматическое шифрование заголовков в провайдерах

Если вы указываете API ключи напрямую в заголовках провайдера (без использования плейсхолдеров), платформа автоматически шифрует следующие чувствительные заголовки:
...
Шифрование происходит автоматически при сохранении провайдера, а расшифровка — при использовании. Вам не нужно ничего делать дополнительно — все происходит прозрачно.
