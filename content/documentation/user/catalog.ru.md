...
В диалоге «Свойства на момент времени» выберите «Дату и время» и нажмите «Показать». Для каждого свойства таблица покажет последнее значение, записанное в историю до выбранного момента.

Свойство не попадёт в таблицу, если до выбранного момента у него нет записей в истории или последней записью его значение удалено.
...
Время хранения истории свойств не ограничено, но история не переживает удаление объекта, к которому относится:
