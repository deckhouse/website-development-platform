...
Ресурсы в каталоге могут быть организованы в иерархическую структуру. Это позволяет логически группировать связанные ресурсы и улучшать навигацию в каталоге.
...
По умолчанию после создания ресурса на его странице будет отображаться таблица с сущностями данного ресурса. При клике на сущность в таблице можно перейти на её страницу.

Если в поле «Использовать дашборд» выбран дашборд, то он будет выводиться на странице ресурса вместо списка сущностей.
...
Страница сущности состоит из встроенных панелей и пользовательских панелей. Встроенные панели:
...
На странице каждой сущности можно добавить новые панели (дашборды).
...
1. В шапке страницы ресурса нажмите кнопку выгрузки (подсказка «Выгрузить сущности ресурса в CSV»).

1. В выгруженный файл попадут все сущности ресурса с учётом строки поиска и сортировки.
