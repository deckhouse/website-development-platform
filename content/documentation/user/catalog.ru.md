...
Если в поле «Использовать дашборд» выбран дашборд, то он будет выводиться на странице ресурса вместо таблицы сущностей.
...
На странице каждой сущности поддерживается добавление новых панелей (дашбордов).
