...
AI-агент — это интеллектуальный помощник, интегрированный в Deckhouse Development Platform, который позволяет анализировать данные из каталога и выполнять различные задачи при помощи инструментов MCP (Model Context Protocol).
