...
- **Enable Monitoring** — переключатель мониторинга для сервиса. Включение включает периодические проверки здоровья по настройкам из конфига мониторинга.
...
- История: **не более 10 записей на сервис**; лимит общий для всех сервисов (10 на каждый).
...
| Лимит записей истории (10 на сервис) | Фиксированное значение платформы, не настраивается |
