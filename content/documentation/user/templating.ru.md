...
Хранилище доступно только в процессах и используется для передачи данных между шагами. Запись — правилами в действиях и элементом «Шаблон» (см. [«Хранилище процесса»](../../admin/processes/store/)); чтение — плейсхолдерами в шаблонах.
