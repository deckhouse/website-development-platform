...
Добавлен виджет **Статус сущности** ([подробнее](../admin/widgets/types/#статус-сущности)):

- отображает общий статус сущности
- показывает детальную информацию о каждой проверке: текущий статус, время последней проверки, сообщения об ошибках
- автоматически определяет и отображает действия, заблокированные текущим статусом сущности

##### Временная шкала сущностей

Добавлен виджет **Временная шкала сущностей** ([подробнее](../admin/widgets/types/#временная-шкала-сущностей)):

- отображает сущности выбранного ресурса на временной шкале

##### Календарь сущностей

Добавлен виджет **Календарь сущностей** ([подробнее](../admin/widgets/types/#календарь-сущностей)):

- отображает сущности выбранного ресурса в календаре
