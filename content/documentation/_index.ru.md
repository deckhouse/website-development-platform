---
title: Обзор
description: Документация продукта Deckhouse Development Portal
weight: 10
params:
  no_list: true
outputs:
...
Deckhouse Development Portal (DDP, портал) — это комплексное решение для управления всеми этапами разработки через единое окно. Портал автоматизирует операции, связанные с жизненным циклом сервисов, и предоставляет инструменты для оценки работы всей системы.

## Основные возможности

- **Единые стандарты разработки для команд**.
  Портал позволяет подготовить шаблоны и типовые конфигурации (CI/CD, Kubernetes и т. д.) и обеспечивает трансляцию стандартов во все команды разработки.
...
- **Упрощённый онбординг разработчиков и команд**.
  Новые сотрудники могут быстро начать работу за счёт шаблонных решений, документации и преднастроенной структуры проектов, которые предоставляет портал.
