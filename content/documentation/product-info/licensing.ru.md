...
Программное обеспечение «Express 42 Platform. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» лицензируется на ограниченный срок или бессрочно. Разные типы лицензий предоставляют разные уровни доступа к поддержке и обновлениям.
...
Программное обеспечение «Express 42 Platform. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» лицензируется по количеству активных учетных записей, заведённых в продукте.
