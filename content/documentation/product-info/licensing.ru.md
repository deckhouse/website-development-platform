...
Программное обеспечение «Express 42 Platform. Платформа для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренняя CI/CD-платформа для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование - Deckhouse Development Platform)» лицензируется по количеству активных учётных записей, заведённых в продукте.
