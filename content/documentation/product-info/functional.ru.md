...
Программное обеспечение «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» обеспечивает выполнение следующих функций:
