...
Программное обеспечение «Express 42 Platform. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» обеспечивает выполнение следующих функций:
