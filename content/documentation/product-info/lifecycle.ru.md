...
Поддержание жизненного цикла программного обеспечения «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» включает:
...
Процесс совершенствования ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» включает в себя следующие этапы:
...
Определение функционала, добавляемого в ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» при обновлении, происходит с использованием продуктового подхода. В качестве используемых методов применяются:
...
Выявление неисправностей в текущей версии дистрибутива ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» производится на основе анализа:
...
Проектирование технического решения осуществляется на основе информации о неисправностях, выявленных в текущей версии ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» и функционала, определённого как необходимого в следующей версии.
...
При разработке ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» применяется система контроля версий, а также прочие современные практики разработки программных продуктов.

### Тестирование функционала, добавленного в ПО

Тестирование функционала, добавленного в ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)», производится с целью:
...
Документация по обновлённой версии дистрибутива ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» описывает:
...
Подготовка обновлённой версии дистрибутива ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)» происходит путем автоматизированной сборки дистрибутива при условии положительного результата, полученного на этапе тестирования функционала.
