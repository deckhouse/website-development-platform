...
Персонал, задействованный в процессе разработки ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)», обладает следующими компетенциями:
...
Персонал, задействованный в процессе сопровождения ПО «Deckhouse Development Portal. Портал для реализации DevOps-практик (Инфраструктурный оркестратор на основе Kubernetes, внутренний CI/CD-портал для команд разработки, SDLC & TM-мониторинг) (альтернативное наименование — Deckhouse Development Portal)», обладает следующими навыками:
